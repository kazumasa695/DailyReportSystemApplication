...
public class ErrorMessage {
    ...
    private final static Map<ErrorKinds, List<String>> errorMessageMap = new HashMap<ErrorKinds, List<String>>() {
...

        {
         ...
         // 氏名空白チェック用エラーメッセージ
            put(ErrorKinds.BLANK_NAME_ERROR, new ArrayList<String>(Arrays.asList("nameError", "値を入力してください")));
            // 氏名長さチェック用エラーメッセージ
            put(ErrorKinds.LENGTH_NAME_ERROR, new ArrayList<String>(Arrays.asList("nameError", "20文字以下で入力してください")));
        }
    };
